...
CUDA_VISIBLE_DEVICES=0 python3 eval_proof1.py --seq_len 4096 --context_size 32768 --sliding_window 2048 --batch_size 1 --base_model /home/wangning/transformer-xl-master/output/llama --peft_model $MODEL_PATH --data_path ./proofpile_test.jsonl --attn_select 0 --lm_select 0
CUDA_VISIBLE_DEVICES=0 python3 eval_proof1.py --seq_len 8192 --context_size 32768 --sliding_window 2048 --batch_size 1 --base_model /home/wangning/transformer-xl-master/output/llama --peft_model $MODEL_PATH --data_path ./proofpile_test.jsonl --attn_select 0 --lm_select 0
CUDA_VISIBLE_DEVICES=0 python3 eval_proof1.py --seq_len 16384 --context_size 32768 --sliding_window 2048 --batch_size 1 --base_model /home/wangning/transformer-xl-master/output/llama --peft_model $MODEL_PATH --data_path ./proofpile_test.jsonl --attn_select 0 --lm_select 0
CUDA_VISIBLE_DEVICES=0 python3 eval_proof1.py --seq_len 32768 --context_size 32768 --sliding_window 2048 --batch_size 1 --base_model /home/wangning/transformer-xl-master/output/llama --peft_model $MODEL_PATH --data_path ./proofpile_test.jsonl --attn_select 0 --lm_select 0
