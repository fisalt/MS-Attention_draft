...
class LlamaAttention_mss_ccc_fpe(nn.Module):
    ...
    def forward(
        ...
        posbias=posfeat[...,None]@self.freqs
...
class LlamaAttention_mss_ccc_R2(nn.Module):
    ...
    def forward(
        ...
        attn_outputs=[]
        window_size=256
        attn_output=forward_localw_inline(self,query_l,key_l,value_l,window_size=256).contiguous()
        # attn_output = attn_output.transpose(1, 2).contiguous()
        ...
        if past_key_value is None:
            attn_outputs,attn_weights,past_key_value1=forward_mss_local_inline_for_ccc(self,query_r,key_r,value_r)
