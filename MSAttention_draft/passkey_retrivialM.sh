...
MODEL_PATH="Mpath_to_saving_checkpoints16k_scale16_m64_w16s512_kojobNTK/checkpoint-$STEPS"
MODEL_PATH="Mpath_to_saving_checkpoints16k_scale64_m64_w16s512_kojobNTK/checkpoint-$STEPS"
MODEL_PATH="Mpath_to_saving_checkpoints16k_scale4096_m64_w16s512_kojobNTK/checkpoint-$STEPS"
...
CUDA_VISIBLE_DEVICES=1 python3 merge_lora_weights_and_save_hf_modelM2.py \
...
CUDA_VISIBLE_DEVICES=1 python3 passkey_retrivial_LBM.py \
        --context_size 16384 \
