...
from llama_attn_replace_o1 import forward_flashattnM,Mistral_mss_ccc_spse,forward_LBe,forward_flashattne,LlamaAttention_mss_cc1,LlamaAttention_mss_ccc,LlamaAttention_mss_ccc_R2,LlamaAttention_mss_ccc_Rt,LlamaAttention_mss_ccc_t,LlamaAttention_mss_ccc_s,LlamaAttention_mss_ccc_sps,LlamaAttention_mss_ccc_sps_mix
...
def main(args):
    ...
    if args.attn_select==1:
        ...
        from llama_attn_replace_o1 import Mistral_mss_ccc_sps2,Mistral_mss_ccc_spse
        for i in range(len(model.model.layers)):
            ...
            # model.model.layers[i].self_attn=Mistral_mss_ccc_spse(config,seg=16,merge=128,top=512,
            #                                                      max_position_embeddings=context_size,scaling_factor=context_size / orig_ctx_len)
            # model.model.layers[i].self_attn.forward = forward_LBe
