...
from llama_attn_replace_o1 import forward_flashattnM,forward_flashattne,LlamaAttention_mss_cc1,LlamaAttention_mss_ccc,LlamaAttention_mss_ccc_R2,LlamaAttention_mss_ccc_Rt,LlamaAttention_mss_ccc_t,LlamaAttention_mss_ccc_s,LlamaAttention_mss_ccc_sps,LlamaAttention_mss_ccc_sps_mix
...
if True:
    ...
    for i in range(len(model.model.layers)):
        ...
        # model.model.layers[i].self_attn = Mistral_mss_ccc_spse
    ...
    #         base=config.rope_theta,
    #     )
    #     model.model.layers[i].self_attn.forward = Mistral_mss_ccc_spse
