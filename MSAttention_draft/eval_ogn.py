...
# from llama_attn_replace_0 import replace_llama_attn
...
def parse_config():
    ...
    parser.add_argument('--replace_l', type=int, default=0, help='')
...
def main(args):
    ...
    stats = evaluate(model.cuda(), data, args.batch_size, device, args.seq_len, sliding_window=args.sliding_window)
